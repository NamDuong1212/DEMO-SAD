...
class Category(models.Model):
    ...
    meta_keyword =  models.CharField(max_length=255, null = False, blank = False)
    meta_description = models.TextField(max_length = 300, null = False, blank = False)
    created_at = models.DateTimeField(auto_now_add=True)
    
    #Sửa lỗi số nhiều của 'Category'
    class Meta:
